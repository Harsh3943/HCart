<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="HCart.SubCategory" %>
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <asp:Panel ID="ListPanel" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:DropDownList ID="ddlSerechCategory"  runat="server"></asp:DropDownList>
                                    ...
                                    <asp:GridView ID="GridSubCategory" class="table table-bordered table-striped dataTable dtr-inline" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SubCategory Name ">
                                                <ItemTemplate>
                                                     <asp:Label ID="lblName" runat="server" Text='<%# Eval("SubCategoryName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Button ID="btnEdit" Class="btn btn-warning btn-md " CommandName="SubCategoryEdit" CommandArgument='<%# Eval("SubCategoryId") %>' runat="server" Text="Edit" />
                                                    <asp:Button ID="BtnDelete" Class="btn btn-primary btn-md " runat="server" CommandArgument='<%# Eval("SubCategoryId") %>' CommandName="SubCategoryDelete" Text="Delete" />
                                                    <asp:Button ID="BtnView" Class="btn btn-secondary btn-md" runat="server" CommandArgument='<%# Eval("SubCategoryId") %>' CommandName="SubCategoryView" Text="View" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtSCName" class="form-control" runat="server"></asp:TextBox>
                                    </div>
